...
<html lang="es">
  <head>
    ...
    <title>Plantilla Adictos al 7mo Arte</title>
  </head>
  <body>
    ...
    <form name="solicitaDatos" method="post" action="controller/procesaDatos.php">
	  ...
	  <div class="row g-2">
	  	...
	  	<div class="col-auto">
		    ...
		    <div id="emailHelp" class="form-text">Ingresa el ID de la Película o Serie</div>
	    </div>
